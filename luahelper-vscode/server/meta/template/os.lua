---@class os @This library is implemented through table os. [`View online doc`](https://www.lua.org/manual/5.1/manual.html#6.8)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/6.8"])
os = {}

--- Returns an approximation of the amount in seconds of CPU time used by the program.
---@return number
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.clock)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.clock"])
...
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.date)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.date"])
...
---@param t1 integer
---@return integer
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.difftime)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.difftime"])
...
---@return integer?  code
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.execute)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.execute"])
...
---@param close? boolean
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.exit)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.exit"])
...
---@return string
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.getenv)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.getenv"])
...
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.remove)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.remove"])
...
---@return boolean suc
---@return string? errmsg
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.rename)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.rename"])
...
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.setlocale)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.setlocale"])
...
---@param date? osdate
---@return integer
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.time)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.time"])
...
---@return string
---[`View online doc`](https://www.lua.org/manual/5.1/manual.html#pdf-os.tmpname)  |  [`View local doc`](command:extension.luahelper.doc?["en-us/51/manual.html/pdf-os.tmpname"])
